...
export default function HowTo({ onClose }: Props) {
  return (
    <div className="absolute inset-0 grid place-items-center rounded-xl bg-blue-950/70">
      {/* 盤面の中で“内容に合わせた高さ”。幅は最大500px、かつ親の92%まで */}
      <div className="w-[92%] max-w-[500px] rounded-xl bg-[#0a4fb8] p-3 text-white ring-4 ring-blue-200 sm:p-4">
        {/* 見出し（コンパクト） */}
        ...
        <div className="mx-auto w-fit flex items-start gap-3 sm:gap-4">
          {/* 左サイドバー（幅を固定） */}
          <div className="w-[78px] sm:w-[82px] flex h-[220px] flex-col sm:h-[232px]">
            {/* ターゲット */}
            <div className="h-[132px] grid place-items-center rounded-lg bg-green-200 text-3xl font-extrabold text-green-900 ring-4 ring-green-600 sm:h-[144px]">
              10
            </div>
            {/* のこり時間／正解数 */}
            <div className="mt-2 grid grid-rows-2 gap-2 sm:mt-3 sm:gap-3">
              <div className="h-[34px] rounded-lg bg-blue-200 px-1.5 py-1 text-center ring-2 ring-blue-700/60 sm:h-[38px]">
                <div className="text-[11px] leading-none text-blue-800/80">のこり時間</div>
                <div className="text-[15px] font-bold leading-tight text-blue-900 sm:text-[16px]">
                  1:00
                </div>
              </div>
              <div className="h-[34px] rounded-lg bg-orange-100 px-1.5 py-1 text-center ring-2 ring-orange-500/60 sm:h-[38px]">
                <div className="text-[11px] leading-none text-orange-800/80">正解数</div>
                <div className="text-[15px] font-bold leading-tight text-orange-700 sm:text-[16px]">
                  0
                </div>
              </div>
            </div>
          ...
          {/* 右：3×3（右ブロックの幅も固定） */}
          <div className="w-[236px] sm:w-[252px]">
            <div
